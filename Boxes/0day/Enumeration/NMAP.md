## NMAP Full
```
# Nmap 7.91 scan initiated Sat Aug 21 21:25:25 2021 as: nmap -oN scans/nmap-fullports -vv 10.10.168.203
Nmap scan report for 10.10.168.203
Host is up, received syn-ack (0.033s latency).
Scanned at 2021-08-21 21:25:25 BST for 0s
...
# Nmap done at Sat Aug 21 21:25:25 2021 -- 1 IP address (1 host up) scanned in 0.62 seconds
```

## NMAP sC sV 
```
# Nmap 7.91 scan initiated Sat Aug 21 21:24:31 2021 as: nmap -sC -sV -oN scans/nmap -vv 10.10.168.203
Nmap scan report for 10.10.168.203
Host is up, received conn-refused (0.034s latency).
Scanned at 2021-08-21 21:24:31 BST for 9s
Not shown: 998 closed ports
Reason: 998 conn-refused
...
# Nmap done at Sat Aug 21 21:24:40 2021 -- 1 IP address (1 host up) scanned in 8.79 seconds
```