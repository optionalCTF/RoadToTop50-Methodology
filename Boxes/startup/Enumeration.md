## NMAP Scan
```
# Nmap 7.91 scan initiated Sat Sep  4 19:16:41 2021 as: nmap -sC -sV -oN scans/nmap -vv 10.10.10.238
Nmap scan report for 10.10.10.238
Host is up, received syn-ack (0.032s latency).
Scanned at 2021-09-04 19:16:41 BST for 8s
...
# Nmap done at Sat Sep  4 19:16:49 2021 -- 1 IP address (1 host up) scanned in 8.82 seconds
```
